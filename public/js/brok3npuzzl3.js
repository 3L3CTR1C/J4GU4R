...
function unScrambleMatrix(matrix, columnsOrder, rowsOrder) {
    ...
    for (var i = 0; i < columnsUnscrambleLevel; i++) {
        matrix = unScrambleColumns(matrix, rowsOrder);
    }
...
// Here, it’s not only about the lyrics; think about the “artworkImg” /Noodle
decodeImage(base64Image, "lettersImg", function() {
    decodeImage(window.artworkImg, "lettersImg", app.init, app);
}, window);
